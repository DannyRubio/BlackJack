...
function sacarCarta(mano) { //++++++++++++++++++++++++++++++++++Comienzo de FUNCION sacarCarta()++++++++++++++++++++++++++++++++++++
    ...
    if (mano.totalSuma < 21) {
        ...
        if (Dealer.cartas >= 2 && Mano1.doubleDown == false) {
            setTimeout(() => {
                activarTodo();
                desactivarFichas();
            }, milisegundos * 5);
    ...
    setTimeout(function () {
        do {
            do {
                ...
                if (isNaN(cantidad) || cantidad < 1  || cantidad == null || ((fichas.cantidad+parseInt(cantidad))>cantidadMax)) {
                    alert("Tienes que introducir un digito, la cantidad total de fichas no puede ser mayor que "+cantidadMax+"€ o menor que 1€");
				}
            } while (isNaN(cantidad) || cantidad == undefined);
        } while ((fichas.cantidad+parseInt(cantidad)) < 1 || (fichas.cantidad+parseInt(cantidad)) > cantidadMax);
    ...
    function pasarFichas(m, n, a, v, r) {
        ...
        if (r != 0) {
            ...
            intervaloR = setInterval(function () {
                ...
                id = ("rojas" + "Nueva2" + (bet2.fichas)).toString(); //cambiar nuevo id para despues conocer el numero de ficha y color
        ...
        setTimeout(function () {
            if (v != 0) {
                ...
                intervaloV = setInterval(function () {
                    ...
                    sacarPosicionYFichaInicial(idElement);
                    document.getElementById(id).remove();
                    id = ("verdes" + "Nueva2" + (bet2.fichas)).toString(); //cambiar nuevo id para despues conocer el numero de ficha y color
                    idElement = ("#" + id).toString();
                    nuevoDiv.setAttribute("id", id);
                    document.body.appendChild(nuevoDiv); //Insertarlo en el documento
                    document.getElementById(id).style.backgroundImage = "url('imagenes/chips/" + imagen + "')";
        ...
        setTimeout(function () {
            if (a != 0) {
                ...
                intervaloA = setInterval(function () {
                    ...
                    sacarPosicionYFichaInicial(idElement);
                    document.getElementById(id).remove();
                    id = ("azules" + "Nueva2" + (bet2.fichas)).toString(); //cambiar nuevo id para despues conocer el numero de ficha y color
                    idElement = ("#" + id).toString();
                    nuevoDiv.setAttribute("id", id);
                    document.body.appendChild(nuevoDiv); //Insertarlo en el documento
                    document.getElementById(id).style.backgroundImage = "url('imagenes/chips/" + imagen + "')";
        ...
        setTimeout(function () {
            if (n != 0) {
                ...
                intervaloN = setInterval(function () {
                    ...
                    sacarPosicionYFichaInicial(idElement);
                    document.getElementById(id).remove();
                    id = ("negras" + "Nueva2" + (bet2.fichas)).toString(); //cambiar nuevo id para despues conocer el numero de ficha y color
                    idElement = ("#" + id).toString();
                    nuevoDiv.setAttribute("id", id);
                    document.body.appendChild(nuevoDiv); //Insertarlo en el documento
                    document.getElementById(id).style.backgroundImage = "url('imagenes/chips/" + imagen + "')";
        ...
        setTimeout(function () {
            if (m != 0) {
                ...
                intervaloM = setInterval(function () {
                    ...
                    sacarPosicionYFichaInicial(idElement);
                    document.getElementById(id).remove();
                    id = ("moradas" + "Nueva2" + (bet2.fichas)).toString(); //cambiar nuevo id para despues conocer el numero de ficha y color
                    idElement = ("#" + id).toString();
                    nuevoDiv.setAttribute("id", id);
                    document.body.appendChild(nuevoDiv); //Insertarlo en el documento
                    document.getElementById(id).style.backgroundImage = "url('imagenes/chips/" + imagen + "')";
...
let numeroFichaPrevia=bet.fichas;
	...
	for (let cId = 0; cId <= 4; cId++) {
		...
		if (document.getElementById(color+"Nueva"+numeroFichaPrevia) != null) {
			...
			document.getElementById(color+"Nueva"+numeroFichaPrevia).style.cursor="default";
			}
...
function cambiarFichas() {
    ...
    document.getElementById("cambiarFichas").disabled = true;
...
function desactivarTodo() {
    ...
    for (var i = 0; i <= 4; i++) {
        ...
        if (document.getElementById(color + "Nueva" + bet[color].toString()) != null) {
            ...
            document.getElementById(color + "Nueva" + bet[color].toString()).style.cursor = "default";
        }
        ...
        if (document.getElementById(color + fichas[color].toString()) != null) {
            ...
            document.getElementById(color + fichas[color].toString()).style.cursor = "default";
        }
    }
}
...
function desactivarFichas() {
    ...
    for (var i = 0; i <= 4; i++) {
        ...
        if (document.getElementById((color + "Nueva2" + bet[color]).toString()) != null) {
            document.getElementById(color + "Nueva2" + bet[color].toString()).onclick = null;
            document.getElementById(color + "Nueva2" + bet[color].toString()).style.cursor = "default";
        }
...
function autoCambiarFichas() {
    ...
    var tiempoTotalFuncion = 0;
    var tiempoEsperaFuncion = 0;
	var tiempoDuracionFuncion = 0;
    var tiempoEsperaFuncionSup = 0;
    var tiempoDuracionFuncionSup = 0;
	...
	while (!isComplete) {
			...
			(function(tiempoEsperaFuncionSup){
            setTimeout(() => {
			tiempoEsperaFuncion=0;
                for (fichaColumna = 1; fichaColumna <= 4; fichaColumna++) {
                    let id = null;
                    var cantidadCambio = 0;
                    tiempoDuracionFuncion = 0;
                    switch (fichaColumna) {
                    case 1:
                    ...
                    tiempoDuracionFuncionSup = (cantidadCambio == 0) ? 0 : (200 + (cantidadCambio * 200));
                    tiempoEsperaFuncionSup += tiempoDuracionFuncion;
                    if (id != null) {
						
                        (function cambiarFicha(id, tiempoEsperaFuncion) {
                            setTimeout(function () {
                                let color = id.substring(0, 1);
                                switch (color) {
                                case "r":
                        ...
                        })(id, tiempoEsperaFuncion);

                        tiempoDuracionFuncion = (cantidadCambio == 0) ? 0 : (200 + (cantidadCambio * 200));
                        tiempoEsperaFuncion += tiempoDuracionFuncion;
                    }
                }
            }, tiempoEsperaFuncionSup);
			})(tiempoEsperaFuncionSup);
			
			tiempoEsperaFuncionSup=0;
		if (((calculoTiempo.rojas >= rojasMax) || calculoTiempo.verdes >= verdesMax || calculoTiempo.azules >= azulesMax || calculoTiempo.negras >= negrasMax)) {
            ...
            tiempoEsperaFuncionSup += tiempoSumar;
			tiempoTotalFuncion+=tiempoEsperaFuncionSup;
		if(!(calculoTiempo.rojas >= rojasMax || calculoTiempo.verdes >= verdesMax || calculoTiempo.azules >= azulesMax || calculoTiempo.negras >= negrasMax))
			isComplete=true;
		tiempoTotalFuncion+=tiempoEsperaFuncionSup;
		setTimeout(()=>{
